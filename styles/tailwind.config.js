...
module.exports = {
    ...
    content: [
        ...
        "./client-brain/**/*.{js,ts,jsx,tsx}",
        "./content-pack/**/*.{js,ts,jsx,tsx}",
        "./content-pipeline/**/*.{js,ts,jsx,tsx}",
    ...
    plugins: [
        ...
        plugin(function ({ addBase, addComponents, addUtilities }) {
            ...
            addComponents({
                ".btn": {
                    "@apply inline-flex items-center justify-center h-13 px-5 border border-n-1 rounded-sm text-base text-n-1 fill-n-1 font-bold transition-all duration-150 ease-in-out hover:shadow-primary-6 active:translate-y-[1px] active:shadow-primary-4":
                        {},
                },
                ".btn svg": {
                ...
                ".card": {
                    "@apply bg-white border border-n-1 shadow-primary-4 transition-all duration-200 ease-out hover:-translate-y-[2px] hover:shadow-primary-6 dark:bg-n-1 dark:border-white":
                        {},
                },
                ".card-head": {
